...
- [Subject](https://github.com/genispicocordo/get_next_line/blob/master/subject/en_subject_get_next_line.pdf) `PDF`

## HOW TO USE
#### 1º - Clone the repository
```git
git clone git@github.com:genispicocordo/get_next_line.git
```
